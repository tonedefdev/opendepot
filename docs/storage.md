...
- `Depot.spec.globalConfig.storageConfig` (applies to resources managed by a Depot unless overridden)
- `Module.spec.moduleConfig.storageConfig`
- `Provider.spec.providerConfig.storageConfig`
- Inline `Version.spec.moduleConfigRef.storageConfig` or `Version.spec.providerConfigRef.storageConfig`
